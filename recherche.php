<?PHP
require  "../core/livraisonC.php";
$LivraisonC=new LivraisonC();
if(!(isset($_GET['recherche']))){
$listeEmploye=$LivraisonC->afficherLivraison();
$listeEmploye1=$LivraisonC->afficherLivraison();
}
else{
	
	$listeEmploye=$LivraisonC->rechercherLivraison($_GET['recherche']);
	$listeEmploye1=$LivraisonC->afficherLivraison();
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li><a href="recherche.php">Livreurs</a></li>
...
foreach($listeEmploye1 as $rows){
  ...
  ?>
  <option value="<?PHP echo $rows['nom_client']; ?>">
   <?PHP
}
?>
</datalist>
...
foreach($listeEmploye as $row){
  ...
  <td><form method="POST" action="../views/supprimerLivraison.php">
  
  <input type="submit" name="supprimer"  class="btn btn-danger"  value="supprimer">
  <input type="hidden" value="<?PHP echo $row['num_livraison']; ?>" name="id">
  </form>
  </td>
  <td><a href="modifierLivraison.php?id=<?PHP echo $row['num_livraison']; ?>" style="text-decorations:none; color:white;"  class="btn btn-warning">
  Modifier</a></td>
  </tr>
  <?PHP
}
