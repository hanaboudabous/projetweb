...
$listeEmployes=$LivreurC->afficherLivreurs();
...
<div id="wrapper" class="container">
  ...
  <h1>Livreurs</h1> 
    ...
    <form id="form-work" class="" name="form-work" action="../views/ajoutEmploye.php" method="GET">
      ...
      <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            <div class="col-md-6">
              <label class="control-label" for="mobile">Prénom</label>
              <div class="input-group">
        ...
        <div class="form-group">
            <div class="col-md-6">
              <label class="control-label" for="district">Date de naissance</label>
              <input name="datedenaissance" class="form-control" placeholder="datedenaissance" type="text">
            </div>
          </div>
           <div class="col-md-6">
           ...
           <div class="col-md-6">
              <label class="control-label" for="district">nombre des jours de travail</label>
              <input name="nbjtravail" class="form-control" placeholder="nbjtravail" type="text">
            </div>

          </div>
           <div class="col-md-6">
              <label class="control-label" for="district">Telephone</label>
...
<table class="table table-hover table-fixed">
  ...
  <thead>
    <tr>
      ...
      <th>Etat</th>
      <th>Nombre des jours de travail</th>
      <th>Telephone</th>
